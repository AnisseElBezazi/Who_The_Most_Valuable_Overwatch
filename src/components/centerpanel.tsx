  ...
  return (
    <div className="bg-white d-flex flex-column h-100 px-4 py-3 position-relative center-panel-wrapper">
      ...
      <div className="d-flex justify-content-between align-items-center mb-4 flex-shrink-0">
        ...
        <button className="btn btn-update-stats text-uppercase">
          UPDATE STATS
        </button>
      ...
      {/* Match Header (Switch + Title) */}
      <div className="d-flex justify-content-between align-items-center mb-4 border-bottom pb-2 match-header-wrapper flex-shrink-0">
